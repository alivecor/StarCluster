...
c.Authenticator.allowed_users = {%(user_whitelist)s}
c.Authenticator.admin_users = {%(admin_whitelist)s}
...
c.Spawner.args = ['--base-url={base_url}']
c.Spawner.debug = True
c.Spawner.default_url = '/{base_url}/lab'
